...
public:
    ...
    MkkDevice(mkk::MkkWindow &window);
    ~MkkDevice();

    // Not copyable or movable
    MkkDevice(const  MkkDevice &) = delete;
    void operator=(const  MkkDevice &) = delete;
    MkkDevice( MkkDevice &&) = delete;
    MkkDevice &operator=( MkkDevice &&) = delete;
